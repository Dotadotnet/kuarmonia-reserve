              ...
              <div className="flex justify-between w-full mt-8">
                ...
                <div className="w-full flex justify-start flex-nowrap  overflow-x-auto sm:px-1 gap-x-2 rtl-scrollbar">
                    ...
                    <button
                      ...
                      className={`whitespace-nowrap py-3 px-1 border-b-2 cursor-pointer font-medium text-sm transition-colors ${
                        activeTab === "overview"
                    ...
                    <button
                      ...
                      className={`whitespace-nowrap py-3 px-1 cursor-pointer border-b-2 font-medium text-sm transition-colors ${
