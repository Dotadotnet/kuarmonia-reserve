...
export default function Chat() {
      const phoneNumber = "+905433575933";
    ...
    return (
      ...
      className="fixed z-50 ping-div-chat ping-animation shadow-2xl text-center flex items-center justify-center rounded-full border-4 text-3xl border-transparent hover:border-[rgb(34,197,94)] dark:hover:border-[rgb(43,127,255)] dark:bg-[rgb(43,127,255)] bg-[rgb(34,197,94)] w-[60px] h-[60px] text-white transition ease-in duration-200"
    >
