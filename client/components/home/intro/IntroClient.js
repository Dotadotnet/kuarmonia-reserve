          ...
          <div ref={contentRef} className="p-0 space-y-8">
            ...
            <div className="prose prose-lg max-w-none dark:text-gray-100 text-gray-800 leading-relaxed space-y-6">
              ...
              >
                {keyFeatures.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="text-sm dark:text-gray-300 text-gray-600 text-justify">
                      {feature.description}
                    </p>
                  </div>
                ))}
              ...
              <div className="p-0">
                ...
                <p className="text-base px-4 text-justify">{about.features.content}</p>
              </div>
              ...
              <div className="p-0">
                ...
                <p className="text-base px-4 text-justify">{about.delivery.content}</p>
              </div>
              ...
              <div className="p-0">
                ...
                <p className="text-base px-4 text-justify">{about.offers.content}</p>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  {additionalCategories.map((category, index) => (
                    <div key={index} className="dark:border-gray-700 border dark:bg-gray-800 border-gray-200 bg-gray-100 p-4 rounded-lg">
                      ...
                      <span className="text-justify">{category.description}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="dark:text-gray-100 text-gray-800 text-sm leading-7 text-justify">
                {seo}
              </div>
            </div>
          </div>
