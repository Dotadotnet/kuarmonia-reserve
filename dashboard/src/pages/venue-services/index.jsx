...
const ListVenueService = () => {
  ...
  useEffect(() => {
    ...
    if (data) {
      toast.success(data?.description, { id: "venueService-loading" });
    }

    if (error?.data) {
      toast.error(error?.data?.description, { id: "venueService-loading" });
    }
    ...
    if (removeError?.data) {
      toast.error(removeError?.data?.description, { id: "venueService-removing" });
    }
