...
const ListVenueSetting = () => {
  ...
  useEffect(() => {
    ...
    if (data) {
      toast.success(data?.description, { id: "venueSetting-loading" });
    }

    if (error?.data) {
      toast.error(error?.data?.description, { id: "venueSetting-loading" });
    }
    ...
    if (removeError?.data) {
      toast.error(removeError?.data?.description, { id: "venueSetting-removing" });
    }
                ...
                <div className="py-2 flex justify-center items-center gap-x-2 text-right">
                  ...
                  <article className="flex-col flex gap-y-2  ">
                    <span className="line-clamp-1 text-base ">
                      <span className=" ">{venueSetting?.title}</span>
                    </span>
