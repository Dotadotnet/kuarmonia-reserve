...
const ListVenueAward = () => {
  ...
  useEffect(() => {
    ...
    if (data?.success) {
      toast.success(data?.message, { id: "venueAward-loading" });
    }
    if (data && !data?.success) {
      toast.error(data?.message, { id: "venueAward-loading" });
    }
    ...
    if (removeData && !isRemoving) {
      toast.dismiss("venueAward-removing");
    }
  ...
  return (
    <>
      <Panel>
        ...
        <AddButton href={"./venue-awards/add"} />
