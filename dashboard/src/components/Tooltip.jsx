...
function Tooltip({
  ...
  return (
    ...
    >
      ...
      <div className={` absolute ${positionOuterClasses(position)}`}>
        <Transition
          show={tooltipOpen}
          tag="div"
          className={`rounded-lg border z-[99999] overflow-hidden shadow-lg ${sizeClasses(size)} ${colorClasses(bg)} ${positionInnerClasses(position)}`}
