    ...
    datasets: [
      {
        ...
        data: [73, 64, 73, 69, 104, 104, 164, 164, 120, 120, 120, 148, 142, 104, 122, 110, 104, 152, 166, 233, 268, 252, 284, 284, 333, 323].map(value => value / 20), // تقسیم بر 10,000,000
      ...
      {
        label: 'مقالات قبلی',
        data: [184, 86, 42, 378, 42, 243, 38, 120, 0, 0, 42, 0, 84, 0, 276, 0, 124, 42, 124, 88, 88, 215, 156, 88, 124, 64].map(value => value / 20), // تقسیم بر 10,000,000
      ...
      {
        label: 'میانگین انتشار',
        data: [122, 170, 192, 86, 102, 124, 115, 115, 56, 104, 0, 72, 208, 186, 223, 188, 114, 162, 200, 150, 118, 118, 76, 122, 230, 268].map(value => value / 20), // تقسیم بر 10,000,000
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      <header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex items-center">
        <h2 className=" text-gray-800 text-center dark:text-gray-100"> آمار فعالیت کاربر </h2>
      </header>
