    ...
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2">
          <h2 className="text-lg  text-gray-800 dark:text-gray-100 mb-2">میزان فروش</h2>
          {/* Menu button */}
          <EditMenu align="right" className="relative inline-flex">
            <li>
              <Link className=" text-sm text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-200 flex py-1 px-3" to="#0">
امروز              </Link>
            </li>
            <li>
              <Link className=" text-sm text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-200 flex py-1 px-3" to="#0">
...
این ماه              </Link>
        ...
        <div className="text-xs  text-gray-400 dark:text-gray-500 uppercase mb-1">فروش</div>
        <div className="flex items-start">
          <div className="text-3xl  text-gray-800 dark:text-gray-100 mr-2">0 ریال</div>
          <div className="text-sm  text-green-700 px-1.5 bg-green-500/20 rounded-full">+49%</div>
        </div>
      </div>
