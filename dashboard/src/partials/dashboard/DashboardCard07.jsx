        ...
        <div className="overflow-x-auto">
          <table className="table-auto w-full dark:text-gray-300">
            ...
            <thead className="text-xs uppercase text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-700 dark:bg-opacity-50 rounded-sm">
              <tr>
                <th className="p-2">
                  <div className="font-semibold text-right">منبع</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">بازدید کننده</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">درآمدها</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">فروش</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">تبدیل</div>
                </th>
              </tr>
            </thead>
            {/* بدنه جدول */}
            <tbody className="text-sm font-medium divide-y divide-gray-100 dark:divide-gray-700/60">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    <svg
                      className="shrink-0 ml-2 sm:ml-3"
                      width="36"
                      height="36"
                      viewBox="0 0 36 36"
                    >
                ...
                <td className="p-2">
                  <div className="text-center text-green-500">ریال3,877</div>
                </td>
                <td className="p-2">
              ...
              <tr>
                ...
                <td className="p-2">
                  <div className="text-center text-green-500">ریال3,426</div>
                </td>
                <td className="p-2">
              ...
              <tr>
                ...
                <td className="p-2">
                  <div className="text-center text-green-500">ریال2,444</div>
                </td>
                <td className="p-2">
              ...
              <tr>
                ...
                <td className="p-2">
                  <div className="text-center text-green-500">ریال2,236</div>
                </td>
                <td className="p-2">
              ...
              <tr>
                ...
                <td className="p-2">
                  <div className="text-center text-green-500">ریال2,034</div>
                </td>
                <td className="p-2">
