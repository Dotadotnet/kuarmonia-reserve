...
function DashboardCard03() {
  const chartData = {
    ...
    datasets: [
      ...
      {
        data: [
          5, 2, 3, 4, 2, 3, 1, 2, 3, 1, 4, 2, 3, 2, 3, 4, 5, 3, 2, 2, 1, 2, 6,
          3, 4, 3
        ],
        fill: true,
      ...
      {
        data: [
          6, 4, 3, 3, 3, 3, 3, 2, 3, 2, 3, 4, 5, 2, 1, 1, 3, 2, 1, 1, 2, 2, 2,
          3, 6, 5
        ],
      ...
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2">
          ...
          <EditMenu align="right" className="relative inline-flex">
            <li>
              <Link
                className=" text-sm text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-200 flex py-1 px-3"
                to="#0"
              >
                امروز{" "}
              </Link>
        ...
        <div className="flex items-start">
          ...
          <div className="text-sm  text-green-700 px-1.5 bg-green-500/20 rounded-full">
            +49%
          </div>
        </div>
      </div>
